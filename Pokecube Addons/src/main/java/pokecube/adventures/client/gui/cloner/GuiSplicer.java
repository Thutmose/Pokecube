...
public class GuiSplicer extends GuiContainer
{
    private static final ResourceLocation guiTexture = new ResourceLocation(
            "pokecube_adventures:textures/gui/splicergui.png");
    IInventory                            tile;

    public GuiSplicer(InventoryPlayer inv, IInventory tile)
    {
        super(new ContainerSplicer(inv, tile));
        this.tile = tile;
    }
    ...
    {
        this.fontRendererObj.drawString(I18n.format("container.splicer", new Object[0]), 28, 6, 4210752);
