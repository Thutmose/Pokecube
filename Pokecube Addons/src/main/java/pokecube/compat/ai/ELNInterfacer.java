...
public class ELNInterfacer
{
	...
	//TODO update this to the better method found in testing
	public static void doELNInterference(EntityLiving entity, int currentRadius, int statFactor, TileEntity tile) throws Exception
	{
		...
		try
		{
			...
			if(node==null || !sixNode.isInstance(node))
				return;
	...
	static Object makeLoad(String name) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException
	{
	...
	static Object makeSource(double voltage, Object loadA) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException{
	...
	static Object makeResistor(double resistance, Object loadA, Object loadB) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException
	{
	...
	static void connectResistorToLoadAndSource(Object resistor, Object sourcePinA, Object load) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException
	{
		connectTo.invoke(resistor, sourcePinA, load);
	}
	
	static void breakConnection(Object component) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException
	{
		breakConnection.invoke(component);
	}
	
	static void reconnect(Object cable) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException
	{
		reconnect.invoke(cable);
	}
	
	static void disconnect(Object cable) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException
	{
	...
	static class CablePacket
	{
		...
		public CablePacket(Vector3 cableLoc, Object resist, Object source, Object a, Object b, Object cab, Object cabLoad)
		{
			resistor = resist;
