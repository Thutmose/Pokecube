...
public class EntityNBTPacket extends AbstractPacket
{
    ...
    // Fairly hacky. Consider swapping to an event driven system, where classes
    // can register to
    // receive entity edit events and provide feedback/send packets as
    // necessary.
    @Override
        ...
        if (e != null)
        {
            try
            {
                ...
                { // Update player info
                    ...
                    player.connection.sendPacket(new SPacketUpdateHealth(player.getHealth(),
