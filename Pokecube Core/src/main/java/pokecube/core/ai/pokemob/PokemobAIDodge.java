...
/**
 * This AI class attempts to make the pokemon dodge an incoming attack.  This is where the calculations should
...
public class PokemobAIDodge extends EntityAIBase {
    ...
    boolean shouldDodge()
    {
    	...
    	if(!entity.onGround && !(dodger.getPokedexEntry().floats()|| dodger.getPokedexEntry().flys()))
    		return dodge;
