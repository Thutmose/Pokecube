...
public class GuiPokemobStorage extends GuiContainer
{
    ...
    public void initGui()
    {
        ...
        int dy = 13;
        int ds = 10;
        berry = new GuiTextField(0, fontRendererObj, xOffset + 10, yOffset + dy + ds * 0, 50, 10);
        storage = new GuiTextField(1, fontRendererObj, xOffset + 10, yOffset + dy + ds * 1, 50, 10);
        storageFace = new GuiTextField(2, fontRendererObj, xOffset + 10, yOffset + dy + ds * 2, 50, 10);
        empty = new GuiTextField(3, fontRendererObj, xOffset + 10, yOffset + dy + ds * 3, 50, 10);
        emptyFace = new GuiTextField(4, fontRendererObj, xOffset + 10, yOffset + dy + ds * 4, 50, 10);
