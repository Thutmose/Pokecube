...
public class StatsInfo extends PokeInfoPage
{
    ...
    void drawInfo(int mouseX, int mouseY, float partialTicks)
    {
        ...
        else
        {
            ...
            int offsetX = -50;
            int dx = 20 + offsetX;
            drawString(fontRendererObj, "HP", x + dx, statYOffSet + 18, 0xFF0000);
            drawString(fontRendererObj, "ATT", x + dx, statYOffSet + 27, 0xF08030);
            drawString(fontRendererObj, "DEF", x + dx, statYOffSet + 36, 0xF8D030);
            drawString(fontRendererObj, "ATTSPE", x + dx, statYOffSet + 45, 0x6890F0);
            drawString(fontRendererObj, "DEFSPE", x + dx, statYOffSet + 54, 0x78C850);
            drawString(fontRendererObj, "VIT", x + dx, statYOffSet + 63, 0xF85888);
    ...
    private void drawInfo(int x, int y)
    {
        ...
        drawString(fontRendererObj, "           TV   IV   EV", x + dx, statYOffSet + 9, 0xFFFFFF);
        drawString(fontRendererObj, "HP", x + dx, statYOffSet + 18, 0xFF0000);
        drawString(fontRendererObj, "ATT", x + dx, statYOffSet + 27, 0xF08030);
        drawString(fontRendererObj, "DEF", x + dx, statYOffSet + 36, 0xF8D030);
        drawString(fontRendererObj, "ATTSPE", x + dx, statYOffSet + 45, 0x6890F0);
        ...
        drawString(fontRendererObj, "" + HP, x + shift, statYOffSet + 18, 0xFF0000);
        drawString(fontRendererObj, "" + ATT, x + shift, statYOffSet + 27, 0xF08030);
        drawString(fontRendererObj, "" + DEF, x + shift, statYOffSet + 36, 0xF8D030);
        drawString(fontRendererObj, "" + ATTSPE, x + shift, statYOffSet + 45, 0x6890F0);
        drawString(fontRendererObj, "" + DEFSPE, x + shift, statYOffSet + 54, 0x78C850);
        drawString(fontRendererObj, "" + VIT, x + shift, statYOffSet + 63, 0xF85888);
        shift += 21;
        drawString(fontRendererObj, "" + HP2, x + shift, statYOffSet + 18, 0xFF0000);
        drawString(fontRendererObj, "" + ATT2, x + shift, statYOffSet + 27, 0xF08030);
        drawString(fontRendererObj, "" + DEF2, x + shift, statYOffSet + 36, 0xF8D030);
        drawString(fontRendererObj, "" + ATTSPE2, x + shift, statYOffSet + 45, 0x6890F0);
        drawString(fontRendererObj, "" + DEFSPE2, x + shift, statYOffSet + 54, 0x78C850);
        drawString(fontRendererObj, "" + VIT2, x + shift, statYOffSet + 63, 0xF85888);
        ...
        if (ability != null)
        {
            drawString(fontRendererObj, "AB: " + I18n.format(ability.getName()), x + dx, y + dy, 0xFFFFFF);
        }
        ...
        fontRendererObj.drawSplitString(message, x + dx, y + dy, 100, 0xFFFFFF);
