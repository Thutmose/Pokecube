...
public class RenderHeldPokemobs implements LayerRenderer<EntityPlayer>
{
    ...
    public RenderHeldPokemobs(RenderLivingBase<?> livingEntityRendererIn)
    {
            ...
            float scale)
    {
        ...
        if (pokemob.getPokemonAIState(IMoveConstants.HELD))
        {
            ...
            RenderPokemobs.getInstance().getRenderer(pokemob.getPokedexEntry()).doRender(entity, 0, 0, 0, 0,
                    partialTicks);
