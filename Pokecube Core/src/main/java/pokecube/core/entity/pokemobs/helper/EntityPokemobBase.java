...
public abstract class EntityPokemobBase extends EntityHungryPokemob implements IMultibox, IBossDisplayData
{
	...
	public void writeEntityToNBT(NBTTagCompound nbttagcompound)
    {
        ...
        if(corruptedSum== -123586)
        	nbttagcompound.setInteger("checkSum", computeCheckSum());
        else
        	nbttagcompound.setInteger("checkSum", corruptedSum);
    }
    @Override
    public void readEntityFromNBT(NBTTagCompound nbttagcompound)
    {
    	...
    	if(checkSum!= computeCheckSum())
    	{
    		...
    		{
    			//((EntityPlayer)getPokemonOwner()).addChatMessage(new ChatComponentText("This Pokemon is Corrupted"));
...
//    		corruptedSum = checkSum;
    ...
    public int computeCheckSum(){
    	...
    	int IVEV = dataWatcher.getWatchableObjectInt(24)+dataWatcher.getWatchableObjectInt(25)+
    			IVs[0]+IVs[1];
    	checkSum += IVEV;
//    	checkSum += getSexe();
    	return checkSum;
    ...
    protected boolean canDespawn()
    {
    	...
    	boolean checks = 
    			getPokemonAIState(TAMED)
    			||this.getPokemonOwner() != null
    			||getPokemonAIState(ANGRY)
    	...
    	boolean cull = Mod_Pokecube_Helper.cull && worldObj.getClosestPlayerToEntity(this, Mod_Pokecube_Helper.mobDespawnRadius)==null;
...
//    		return;
	...
	public void setOffsets() {
		if(offset==null)
			offset = Vector3.getNewVectorFromPool();
	...
	public void checkCollision() {
		//TODO see if I need anything here, of if the LogicCollision will handle it.
	}
