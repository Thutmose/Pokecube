...
public class ItemHandler extends Mod_Pokecube_Helper
{
    ...
    public static void addItems(Mod_Pokecube_Helper helper)
    {
        ...
        register(repelBlock, ItemBlockTranslated.class, "repel");
        ...
        register(tableBlock, ItemBlockTranslated.class, "pokecube_table");
        ...
        register(pokecenter, ItemBlockTranslated.class, "pokecenter");
        if (FMLCommonHandler.instance().getEffectiveSide() == Side.CLIENT)
        {
        ...
        PokecubeItems.register(nest, ItemBlockTranslated.class, "pokemobNest");
        ...
        tradingtable.setCreativeTab(mod_Pokecube.creativeTabPokecubeBlocks);
        ...
        pc = (BlockPC) (new BlockPC()).setUnlocalizedName("pc");
        GameRegistry.registerTileEntity(pokecube.core.blocks.pc.TileEntityPC.class, "pc");
        pc.setCreativeTab(mod_Pokecube.creativeTabPokecubeBlocks);
    ...
    {
        Block fossilStone = (new BlockFossilStone()).setHardness(3F).setResistance(4F).setUnlocalizedName("fossilstone");
        ...
        if(FMLCommonHandler.instance().getEffectiveSide() == Side.CLIENT)
        {
            PokecubeItems.registerItemTexture(fossilLileep, 0, new ModelResourceLocation("pokecube:fossilLileep", "inventory"));
        }
        ...
        if(FMLCommonHandler.instance().getEffectiveSide() == Side.CLIENT)
        {
            PokecubeItems.registerItemTexture(fossilAnorith, 0, new ModelResourceLocation("pokecube:fossilAnorith", "inventory"));
        }
        ...
        if(FMLCommonHandler.instance().getEffectiveSide() == Side.CLIENT)
        {
            PokecubeItems.registerItemTexture(fossilCranidos, 0, new ModelResourceLocation("pokecube:fossilCranidos", "inventory"));
        }
        ...
        if(FMLCommonHandler.instance().getEffectiveSide() == Side.CLIENT)
        {
            PokecubeItems.registerItemTexture(fossilShieldon, 0, new ModelResourceLocation("pokecube:fossilShieldon", "inventory"));
        }
        ...
        PokecubeBehavior snag = new PokecubeBehavior()
        {
            ...
            public void onPreCapture(Pre evt)
            {
                if (evt.caught.isShadow())
                {
                    ...
                    IPokemob mob = (IPokemob) mod_Pokecube.instance.createEntityByPokedexNb(evt.caught.getPokedexNb(),
                            cube.worldObj);
    ...
    {
        waterstone = (new ItemTranslated()).setUnlocalizedName("waterstone");
        ...
        firestone = (new ItemTranslated()).setUnlocalizedName("firestone");
        ...
        leafstone = (new ItemTranslated()).setUnlocalizedName("leafstone");
        ...
        thunderstone = (new ItemTranslated());
        ...
        moonstone = (new ItemTranslated()).setUnlocalizedName("moonstone");
        ...
        sunstone = (new ItemTranslated()).setUnlocalizedName("sunstone");
        ...
        shinystone = (new ItemTranslated()).setUnlocalizedName("shinystone");
        ...
        ovalstone = (new ItemTranslated()).setUnlocalizedName("ovalstone");
        ...
        everstone = (new ItemTranslated()).setUnlocalizedName("everstone");
        ...
        duskstone = (new ItemTranslated()).setUnlocalizedName("duskstone");
        ...
        dawnstone = (new ItemTranslated()).setUnlocalizedName("dawnstone");
        ...
        kingsrock = (new ItemTranslated()).setUnlocalizedName("kingsrock");
