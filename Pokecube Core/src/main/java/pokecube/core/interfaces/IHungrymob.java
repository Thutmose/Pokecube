...
{
	/**
	 * Called when the mob eats the Entity e.  e can be any entity, will often be an EntityItem.
	 * @param e
	 */
	public void eat(Entity e);
	/**
	 * Called when the mob fails to eat the entity, this is often because it was already eaten by someone else.
	 * @param e
	 */
	public void noEat(Entity e);
	/**
	 * returns true if the mob is not actually a hungry mob, but uses the interface for something else.
	 * @return
	 */
	...
	/**
	 * @return Cooldown time between looking for meal, will only look if this is less than or equal to 0
	 */
