...
public class WorldGenStartBuilding implements IWorldGenerator {
	...
	public void generate(Random random, int chunkX, int chunkZ, World world,
		...
		if(building || !ConfigHandler.SPAWNBUILDING)
			return;
	...
	public static void makePokecenter(Vector3 centre, World world)
	{
        ...
        //Walls
        fillWithBlocks(world, centre, temp1.set(8, 3, 0), temp2.set(8, 5, 8), Blocks.planks, 1);//RIGHT WALL
        fillWithBlocks(world, centre, temp1.set(0, 3, 8), temp2.set(8, 5, 8), Blocks.planks, 1);//LEFT WALL
        fillWithBlocks(world, centre, temp1.set(0, 3, 0), temp2.set(0, 5, 8), Blocks.planks, 1);//BACK WALL
        fillWithBlocks(world, centre, temp1.set(0, 3, 0), temp2.set(8, 5, 0), Blocks.planks, 1);//FRONT WALL
        //CORNERS
        ...
        temp1.set(centre).addTo(4, 7, 3).setBlock(world, Blocks.redstone_block.getDefaultState());//redstone to power lamp
        ...
        //accessories
        temp1.set(centre).addTo(6, 3, 5).setBlock(world, PokecubeItems.getBlock("pc").getDefaultState());//PC Base
        temp1.set(centre).addTo(6, 4, 5).setBlock(world, PokecubeItems.getBlock("pc").getStateFromMeta(8));//PC Top
        temp1.set(centre).addTo(2, 3, 5).setBlock(world, PokecubeItems.getBlock("tradingtable").getDefaultState());//trading table
        temp1.set(centre).addTo(1, 3, 1).setBlock(world, PokecubeItems.getBlock("pokecube_table").getDefaultState());//poke table
        temp1.set(centre).addTo(4, 3, 7).setBlock(world, PokecubeItems.pokecenter.getDefaultState());//healing table
        temp1.set(centre).addTo(4, 2, 7).setBlock(world, Blocks.redstone_torch.getDefaultState());//table power
        
        //DOOR
//        temp1.set(centre).addTo(4, 4, 0).setBlock(world, Blocks.air.getDefaultState());//door
//        temp1.set(centre).addTo(4, 3, 0).setBlock(world, Blocks.oak_door.getDefaultState());//door
