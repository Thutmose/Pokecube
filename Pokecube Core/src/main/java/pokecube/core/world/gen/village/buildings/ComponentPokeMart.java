...
public class ComponentPokeMart extends ComponentVillageBase {
	...
	public ComponentPokeMart(Start par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, EnumFacing par5) {
...
//        StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5, 9, 8, 9, par6);
        ...
        return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(pieces, structureboundingbox) == null ? new ComponentPokeMart(startPiece, p5, random, structureboundingbox, facing) : null;
    }
	...
	public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox) {
        ...
        if(here.isAir(world)&&!here.offset(EnumFacing.DOWN).isAir(world))
        	this.placeBlockAtCurrentPosition(world, Blocks.stone_stairs, //this.getBiomeSpecificBlock(Blocks.stone_stairs, 0)
        ...
        if(ConfigHandler.POKEMARTSELLER)
        {
	    	...
	    	//	villager.tasks.taskEntries.clear();
	    		villager.tasks.addTask(2, new GuardAI(villager, new BlockPos(globalX, globalY, globalZ),
